      ...
      <div className="mt-8 space-y-2">
        ...
        <Link
          ...
          className={`flex items-center px-4 py-3 ${
            pathname === publicProfileUrl ? "bg-gray-800" : "hover:bg-gray-800"
          }`}
        >
          <svg
            className="w-6 h-6 mr-3"
        ...
        <Link
          href="/notifications"
          className={`flex items-center px-4 py-3 ${
            pathname === "/notifications" ? "bg-gray-800" : "hover:bg-gray-800"
          }`}
        >
          <svg
            className="w-6 h-6 mr-3"
        ...
        <Link
          href="/profile/drafts"
          className={`flex items-center px-4 py-3 ${
            pathname === "/profile/drafts" ? "bg-gray-800" : "hover:bg-gray-800"
          }`}
        >
          <svg
            className="w-6 h-6 mr-3"
