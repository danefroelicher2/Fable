// src/components/CommunityCommentSection.tsx - SEPARATE COMPONENT FOR COMMUNITY POSTS
"use client";
...
export default function CommunityCommentSection({
  ...
  async function handleSubmitComment(e: React.FormEvent) {
    ...
    try {
      ...
      // Try to create a notification for the post owner
      try {
        // Fetch post owner id to create notification
        ...
        if (!postError && postData) {
          // Only create notification if the post owner isn't the current user
      ...
      {loading ? (
        ...
        <div className="space-y-6">
          {comments.map((comment) => (
            <div
              key={comment.id}
              className="bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow p-4 dark:bg-gray-800"
            >
              <div className="flex">
                <div className="mr-3 flex-shrink-0">
                  <div className="h-8 w-8 rounded-full bg-gray-300 dark:bg-gray-700 flex items-center justify-center text-gray-600 dark:text-gray-400 overflow-hidden">
                  ...
                  <div className="flex items-center justify-between mb-1">
                    <div className="flex items-center">
                      <Link
                        ...
                        className="font-medium mr-2 hover:text-blue-600 dark:text-white dark:hover:text-blue-400"
                      >
              ...
              {/* Reply Form */}
              {replyingTo === comment.id && user && isMember && (
                <div className="mt-3 ml-11">
                  <div className="flex items-start">
                    <div className="mr-3 flex-shrink-0">
                      <div className="h-6 w-6 rounded-full bg-gray-300 dark:bg-gray-700 flex items-center justify-center text-gray-600 dark:text-gray-400 overflow-hidden">
                        {user?.email?.charAt(0).toUpperCase() || "U"}
                      </div>
                    </div>
                    <div className="flex-grow">
                      <textarea
                        ...
                        className="w-full p-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400 text-sm dark:bg-gray-700 dark:border-gray-600 dark:text-white"
              ...
              {expandedReplies[comment.id] &&
                ...
                comment.replies.length > 0 && (
                  <div className="mt-3 ml-11 space-y-4 pt-2 border-t border-gray-100 dark:border-gray-700">
                          ...
                          <div className="flex justify-between items-center mb-1">
                            <div>
                              <Link
                                ...
                                className="font-medium mr-2 text-sm hover:text-blue-600 dark:text-white dark:hover:text-blue-400"
                              >
